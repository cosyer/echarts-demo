        ...
        option = {
          tooltip: {
            ...
            formatter: function (param) {
              let html =
                '<div class="tool-tip"><h3 style="color:#d3edff;text-align: center;">' +
                param.seriesName +
                '</h3><div style="padding: 3px 0;color:#8bb8e8;text-align: left;">' +
                param.data.name +
                ':<label <span style="color:#ffbf00;font-weight: bold;font-size:14px;padding: 0 5px;">' +
                param.data.value +
                "万个</label>" +
                "</div></div>";
              return html;
